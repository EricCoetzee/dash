                ...
                <div class="post__info">
                    ...
                    <div class="post__btn-box">
                        <div class="post__stats">
                            <a <?php echo "onClick=\"javascript: return confirm('Are you sure you want to delete?')\"" ?> class='bttn bttn__min bttn--main' href='classifieds.php?delete=<?php echo $row['post_id'] ?>'> Delete</a>
                        </div>
                        <div class="post__stats">
                            <a class='bttn bttn__min bttn--blue' href='classifieds/edit_classifieds&p_id=<?php echo $row['post_id'] ?>'> Edit</a>
                        </div>
                    </div>
                </div>
            </figure>
